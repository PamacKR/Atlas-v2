...
(async () => {
  ...
  if (darkLogoSource !== 'assets/atlas-logo-dark.svg') throw new Error(`FAIL: dark theme used the wrong logo asset: ${darkLogoSource}`);
  ...
  if (lightLogoSource !== 'assets/atlas-logo-light.svg') throw new Error(`FAIL: light theme used the wrong logo asset: ${lightLogoSource}`);
